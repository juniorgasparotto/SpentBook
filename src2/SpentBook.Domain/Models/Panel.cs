...
namespace SpentBook.Domain
{
    public class Panel : IEntity
    {
        ...
        public PanelDataType GetDataType()
        {
            ...
            {
                if (this.Filter.OrderBy == TransactionOrder.Date)
        ...
        private Expression<Func<Transaction, object>> GetGroupByExpression(TransactionGroupBy group, out string groupName)
        {
            switch (group)
            {
        ...
        private Expression<Func<Transaction, object>> GetOrderByExpression(TransactionOrder orderBy, out string orderByName)
        {
            switch (orderBy)
            {
        ...
        private Expression<Func<TransactionGroup, object>> GetOrderByGroupExpression(TransactionGroupOrder orderBy, out string orderByName)
        {
            switch (orderBy)
            {
        ...
        private static object GetTransactionGroupOrderByValue(TransactionGroup transactionGroup, TransactionGroupOrder orderBy)
        {
            switch (orderBy)
            {
                case TransactionGroupOrder.Agrupador:
