...
namespace SpentBook.Web.Controllers
{
    public static class Helper
    {
        ...
        //public static string GetUserDataBase(HttpContext context, ClaimsPrincipal user)
        //{
        ...
        //public static IUnitOfWork GetUnitOfWorkByCurrentUser(HttpContext context)
        //{
        //    if (UoW == null)
        //    {
        //        var databaseFile = Helper.GetUserDataBase(context, context.User);
